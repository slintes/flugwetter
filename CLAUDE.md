...
- **The plan is not authoritative and not complete.** DFS says so: below FL100 only, "may not be complete", AIP ENR 5.1 and NOTAM govern. The map panel carries that disclaimer, and nothing here may imply otherwise.
