...
| `vfr-breakdown.js` | Formats the VFR rating's breakdown for the tooltip: what each factor was, and how it rated. |
...
**`viewport.js`, `barbs.js`, `time.js`, `vfr-breakdown.js`, `status.js`, `bands.js` and
